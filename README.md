# Desafio Front-end LDS (Angular): js, html, css

#### Objetivo:

Desenvolver o front-end de uma  Agenda de Compromissos (CRUD) utilizando Angular.js e consumindo uma API Restful.
...
- O template do Angular.js já está disponível. Basta fazer as configurações necessárias para o projeto.
...
2. Crie uma branch com o padrão `seunome-desafio-frontend-Angular`.
...
Em caso de dúvidas, [abra uma issue](https://github.com/lds-ulbra-torres/desafio-frontend-angularjs/issues)
